...
import { FiHome, FiPackage, FiGift, FiShoppingBag, FiCalendar, FiImage, FiStar, FiUsers, FiSettings, FiLogOut, FiChevronDown, FiChevronRight, FiBriefcase } from 'react-icons/fi';
