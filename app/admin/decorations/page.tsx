...
export default function DecorationsPage() {
  ...
  const handleEdit = (decoration: Decoration) => {
    ...
    setFormData({
      ...
      minimum_dp_percentage: (decoration as any).minimum_dp_percentage || 30
    });
    setShowModal(true);
  };
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-5 mb-6">
                ...
                <div className="col-span-2 bg-blue-50 p-4 rounded-xl border border-blue-100">
                    <h4 className="text-sm font-bold text-black mb-3 uppercase tracking-wide flex items-center gap-2">
                      <svg className="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                      </svg>
                      Down Payment (DP) Settings
                    </h4>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2">
                          ...
                          <input
                            type="number"
                            value={formData.minimum_dp_percentage}
                            onChange={(e) => setFormData({ ...formData, minimum_dp_percentage: Math.min(100, Math.max(10, Number(e.target.value))) })}
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Customer dapat membayar minimal {formData.minimum_dp_percentage}% dari total harga (min: 10%, max: 100%)
                          </p>
                        </div>
                    </div>
                </div>
